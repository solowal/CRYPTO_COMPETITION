from pub_data_handler import convert_btr_2_npy, convert_hex_data_2_npy
import numpy as np
#%%
AES_S_BOX = (
...
#%%
# AVR-AES 라벨링
traces = convert_btr_2_npy((22350, 23850), "../data/STM-AES.btr", None)
plain = convert_hex_data_2_npy("../data/STM-AES-plain.txt", None)
keys = convert_hex_data_2_npy("../data/STM-AES-key.txt", None)
...
np.save("../npy/stm-aes-traces.npy", label)
np.save("../npy/stm-aes-traces.npy", traces)
